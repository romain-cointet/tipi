...
$(function() {
  ...
  $("#total-students").text(students.length + ' étudiants inscrits');
  $("#total-jobs").text(jobs.length + ' jobs étudiants dans la ville');
  $("#total-places").text(places.length + ' lieux à visiter dans la ville');
